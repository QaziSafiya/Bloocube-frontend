  ...
  return (
    <div className="h-screen bg-gray-50 flex flex-col ">
      ...
      <div className="flex-1 flex overflow-hidden ">
        ...
        <div className="p-4 md:p-6 flex-1 overflow-y-auto p-6 bg-gradient-to-br from-purple-100 to-blue-100 ">
          <div className="bg-white rounded-lg shadow-sm">
            ...
            <div className="p-4 md:p-6 space-y-6 md:space-y-8">
              ...
              <section>
                ...
                <p className="text-sm text-gray-600 mb-6">
                  Connect other accounts with external providers to access your
                  content
                </p>
              ...
              <section>
                ...
                <p className="text-sm text-gray-600 mb-6">
                  Choose how you'd like to receive updates about your Biocube
                  Vision
                </p>
                ...
                <div className="space-y-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-500">
                        Receive product news, feature updates and special offers
                        via email
                      </p>
                    </div>
                    <ToggleSwitch
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-500">
                        Get alerts about your tasks, projects and team
                        communication
                      </p>
                    </div>
                    <ToggleSwitch
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-500">
                        Get push notifications on your mobile device and browser
                      </p>
                    </div>
                    <ToggleSwitch
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-500">
                        Receive email reminders for upcoming posts or urgent
                        project deadlines
                      </p>
                    </div>
                    <ToggleSwitch
              ...
              <section>
                ...
                <p className="text-sm text-gray-600 mb-6">
                  Generate or manage API keys for third-party integrations and
                  custom applications
                </p>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-2">
                      Warning: When regenerating an API key, all integrations
                      and applications using the previous key will stop working
                      until they use the new key.
                    </p>
                  </div>
